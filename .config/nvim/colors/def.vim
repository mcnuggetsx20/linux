...
let s:p={
      ...
      \ 'gutter': ['#313335', 236],
      \ 'selection': ['#214283', 24],
      \ 'cursorLine': ['#a52a2a', 236],
      \ 'cursorLineNr': ['#a52a2a', 248],
      \ 'errorMsg': ['#CC666E', 174],
      \ 'error': ['#BC3F3C', 131],
      \ 'warning': ['#A9B7C6', 145],
      \ 'muted': ['#606060', 241],
      ...
      \ 'lineNumber': ['#a52a2a', 241],
      \ 'matchBraceFg': ['#a52a2a', 220],
      \ 'matchBraceBg': ['#FFFFFF', 59],
      \ 'todo': ['#2805f6', 142],
      \ 'search': ['#ffff00', 23],
      \ 'incSearch': ['#155221', 22],
      \ 'foldedFg': ['#8C8C8C', 245],
