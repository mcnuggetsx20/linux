...
--
main = do
  xmproc <- spawnPipe "xmobar -x 0 /home/kowalczyk/.xmonad/xmobar/xmobar.config"
  xmproc <- spawnPipe "xmobar -x 1 /home/kowalczyk/.xmonad/xmobar/xmobar.config"
